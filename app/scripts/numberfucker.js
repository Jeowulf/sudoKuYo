...
function popSud(sudName) {
  for (var i = 0; i<81; i++) {
    ...
    if (num<42) {
      ...
      sudOneComp.splice(i,1,sudName[i]);
    }
  }
}
function popSud2(sudName) {
  for (var i = 0; i<81; i++) {
    getRandomInt(1, 100);
      ...
      sudTwoComp.splice(i,1,sudName[i]);
    }
  }
}
function popSud3(sudName) {
  for (var i = 0; i<81; i++) {
    getRandomInt(1, 100);
      ...
      sudThreeComp.splice(i,1,sudName[i]);
    }
  }
}
function popSud4(sudName) {
  for (var i = 0; i<81; i++) {
    getRandomInt(1, 100);
      ...
      sudFourComp.splice(i,1,sudName[i]);
    }
  }
}
function popSud5(sudName) {
  for (var i = 0; i<81; i++) {
    getRandomInt(1, 100);
      ...
      sudFiveComp.splice(i,1,sudName[i]);
    }
  }
}
function popSud6(sudName) {
  for (var i = 0; i<81; i++) {
    getRandomInt(1, 100);
      ...
      sudSixComp.splice(i,1,sudName[i]);
    }
  }
}
